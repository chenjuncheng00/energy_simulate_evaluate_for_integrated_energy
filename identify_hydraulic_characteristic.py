...
from model_fmu_input_data_default import environment_input_data_default, chiller_input_data_default, \
                                         ...
                                         user_load_input_data_default, main_input_data_default
...
def main_identify_hydraulic_characteristic(fmu_unzipdir, fmu_description, load_mode, start_time, stop_time,
    ...
    identify_full_open(n_chiller1, n_chiller2, n_chiller_chilled_pump1, n_chiller_chilled_pump2,
                       ...
                       time_data, chiller_data, chiller_cooling_tower_data, air_source_heat_pump_data, fmu_unzipdir,
                       fmu_description, load_mode, start_time, stop_time, time_out, tolerance, model_input_type,
                       model_output_name, output_interval, full_open_result_txt_path)
                ...
                for l in range(n_chiller_chilled_pump2 + 1):
                    ...
                    for m in range(len(chiller1_chilled_pump_f_list)):
                        ...
                        model_input_data = time_data + environment_input_data_default(load_mode) + chiller_data + \
                                           ...
                                           chiller_user_valve_data + air_source_heat_pump_input_data_default() + \
                                           cold_storage_input_data_default() + user_load_input_data_default()
                        # FMU仿真
                        try:
                            time1 = time.time()
            ...
            for k in range(n_storage_chilled_pump + 1):
                ...
                for l in range(len(storage_chilled_pump_f_list)):
                    ...
                    model_input_data = time_data + environment_input_data_default(load_mode) + chiller_data + \
                                       ...
                                       chiller_cooling_valve_data + chiller_tower_valve_data + \
                                       chiller_user_valve_data + air_source_heat_pump_input_data_default() + \
                                       storage_chilled_pump_data + storage_chiller_valve_data + storage_user_valve_data + \
    ...
    for i in range(n_storage_chilled_pump + 1):
        ...
        for j in range(len(storage_chilled_pump_f_list)):
            ...
            model_input_data = time_data + environment_input_data_default(load_mode) + chiller_input_data_default() + \
                               ...
                               storage_chiller_valve_data + storage_user_valve_data + user_load_input_data_default()
            # FMU仿真
            try:
                time1 = time.time()
                    ...
                    for m in range(n_storage_chilled_pump + 1):
                        ...
                        for n in range(len(chiller1_chilled_pump_f_list)):
                            ...
                            model_input_data = time_data + environment_input_data_default(load_mode) + chiller_data + \
                                               ...
                                               chiller_cooling_valve_data + chiller_tower_valve_data + \
                                               chiller_user_valve_data + air_source_heat_pump_input_data_default() + \
                                               storage_chilled_pump_data + storage_chiller_valve_data + \
                                               storage_user_valve_data + user_load_input_data_default()
                            # FMU仿真
                            try:
                                time1 = time.time()
                                result = simulate_sample(fmu_unzipdir, fmu_description, None, start_time, stop_time,
...
def identify_full_open(n_chiller1, n_chiller2, n_chiller_chilled_pump1, n_chiller_chilled_pump2,
    ...
    model_input_data = time_data + environment_input_data_default(load_mode) + chiller_data + \
                       ...
                       chiller_cooling_tower_data + chiller_chilled_valve_data + \
                       chiller_cooling_valve_data + chiller_tower_valve_data + \
                       chiller_user_valve_data + air_source_heat_pump_input_data_default() + storage_chilled_pump_data + \
                       storage_user_valve_data + storage_chiller_valve_data + user_load_input_data_default()
    try:
        time1 = time.time()
    ...
    model_input_data = time_data + environment_input_data_default(load_mode) + chiller_data + \
                       ...
                       chiller_cooling_tower_data + chiller_chilled_valve_data + \
                       chiller_cooling_valve_data + chiller_tower_valve_data + \
                       chiller_user_valve_data + air_source_heat_pump_data + ashp_chilled_pump_data + \
                       ashp_chilled_valve_data + storage_chilled_pump_data + storage_user_valve_data + \
                       storage_chiller_valve_data + user_load_input_data_default()
    try:
        time1 = time.time()
    ...
    model_input_data = time_data + environment_input_data_default(load_mode) + chiller_data + \
                       ...
                       chiller_cooling_tower_data + chiller_chilled_valve_data + \
                       chiller_cooling_valve_data + chiller_tower_valve_data + \
                       chiller_user_valve_data + air_source_heat_pump_data + \
                       ashp_chilled_pump_data + ashp_chilled_valve_data + \
                       cold_storage_input_data_default() + user_load_input_data_default()
    try:
        time1 = time.time()
