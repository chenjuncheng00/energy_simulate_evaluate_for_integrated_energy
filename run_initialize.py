...
from system_default_status import air_source_heat_pump_default_status, chiller_default_status
...
if __name__ == "__main__":
    ...
    initialize_txt_chiller(txt_path, n_chiller, 0, n_chiller_chilled_pump, n_chiller_cooling_pump,
                           n_chiller_cooling_tower, n_user_value, n_tower_chilled_value)
    ...
    initialize_txt_air_source_heat_pump(txt_path, n_air_source_heat_pump, 0, n_ashp_chilled_pump, n_user_value)

    # 冷却塔直接供冷设备数量
    n_chilled_pump = read_cfg_data(cfg_path_equipment, "一级冷冻水泵_冷却塔直接供冷", "n_chilled_pump", 1)
    n_chilled_pump_secondary = read_cfg_data(cfg_path_equipment, "二级冷冻水泵", "n_chilled_pump_secondary", 1)
    initialize_txt_tower_chilled(txt_path, n_chilled_pump_secondary, n_chilled_pump)
