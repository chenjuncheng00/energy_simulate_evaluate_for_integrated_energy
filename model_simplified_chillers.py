...
def model_dynamics_simplified_chillers():
    ...
    # 水泵和冷却塔频率50Hz-->45Hz
    # EER模型: Q=1900kW
    tf11_1 = (-1.274 * s + 0.0001571) / (s + 0.004256)
    tf12_1 = (-2.926 * 10 ** (-5)) / (s + 0.007777)
    tf13_1 = (-0.00315 * s - 5.676 * 10 ** (-5)) / (s + 0.01795)
    tf14_1 = (-0.003757 * s - 5.005 * 10 ** (-5)) / (s + 0.01643)
    tf1_EER_list = [[tf11_1, tf12_1, tf13_1, tf14_1]]
    # Tei模型: Q=1900kW
    tf21_1 = (0.004361) / (s + 0.004362)
    tf22_1 = (-9.036 * 10 ** (-6)) / (s + 0.004167)
    tf23_1 = (0) / (1)
    tf24_1 = (0) / (1)
    ...
    # 水泵和冷却塔频率45Hz-->40Hz
    # EER模型: Q=1900kW
    tf11_2 = (-1.125 * s ** 2 - 0.4224 * s + 6.477 * 10 ** (-5)) / (s ** 2 + 0.326 * s + 0.001329)
    tf12_2 = (-2.573 * 10 ** (-5)) / (s + 0.006254)
    tf13_2 = (-0.003476 * s - 6.049 * 10 ** (-5)) / (s + 0.01732)
    tf14_2 = (-0.005242 * s - 5.984 * 10 ** (-5)) / (s + 0.01503)
    tf2_EER_list = [[tf11_2, tf12_2, tf13_2, tf14_2]]
    # Tei模型: Q=1900kW
    tf21_2 = (0.00383) / (s + 0.003831)
    tf22_2 = (-1.015 * 10 ** (-5)) / (s + 0.003621)
    tf23_2 = (0) / (1)
    tf24_2 = (0) / (1)
    ...
    # 水泵和冷却塔频率40Hz-->35Hz
    # EER模型: Q=1900kW
    tf11_3 = (-0.9132 * s ** 2 - 0.7205 * s + 0.0001446) / (s ** 2 + 0.6057 * s + 0.002257)
    tf12_3 = (-2.132 * 10 ** (-5)) / (s + 0.004974)
    tf13_3 = (-0.003672 * s - 6.541 * 10 ** (-5)) / (s + 0.01769)
    tf14_3 = (-0.005877 * s - 4.782 * 10 ** (-5)) / (s + 0.01327)
    tf3_EER_list = [[tf11_3, tf12_3, tf13_3, tf14_3]]
    # Tei模型: Q=1900kW
    tf21_3 = (0.003323) / (s + 0.003324)
    tf22_3 = (-1.148 * 10 ** (-5)) / (s + 0.003103)
    tf23_3 = (0) / (1)
    tf24_3 = (0) / (1)
    ...
    # 水泵和冷却塔频率35Hz-->30Hz
    # EER模型: Q=1900kW
    tf11_4 = (-0.5896 * s ** 2 - 0.07306 * s + 2.081 * 10 ** (-5)) / (s ** 2 + 0.07826 * s + 0.0002519)
    tf12_4 = (-1.61 * 10 ** (-5)) / (s + 0.003854)
    tf13_4 = (-0.003655 * s - 7.541 * 10 ** (-5)) / (s + 0.0204)
    tf14_4 = (-0.004346 * s - 2.526 * 10 ** (-6)) / (s + 0.01162)
    tf4_EER_list = [[tf11_4, tf12_4, tf13_4, tf14_4]]
    # Tei模型: Q=1900kW
    tf21_4 = (0.002838) / (s + 0.002838)
    tf22_4 = (-1.309 * 10 ** (-5)) / (s + 0.002601)
    tf23_4 = (0) / (1)
    tf24_4 = (0) / (1)
    ...
    q_EER_list = [[q1_list[0]], [q2_list[0]], [q3_list[0]], [q4_list[0]]]
    q_Tei_list = [[q1_list[1]], [q2_list[1]], [q3_list[1]], [q4_list[1]]]
    # 每个模型对应的制冷功率Q的列表
    Q_model_list = [1900, 1900, 1900, 1900]
    # 返回结果
    return (Q_model_list, model_list, model_EER_list, model_Tei_list, Np_list, Nc_list, r_list, q_list,
            q_EER_list, q_Tei_list)


def model_old_dynamics_simplified_chillers():
    """
